...
$pdf->Ln(0);
$pdf->Cell(87, 10, $RazonSocial, 0,0,'C');
$pdf->SetFont('arial', 'B', 20);
$pdf->Cell(16, 10, $tipoFactura, 0,0,'C');
$pdf->SetFont('arial', 'B', 14);
$pdf->Cell(87, 10, '     Presupuesto n: '.$nPed, 0);
$pdf->Ln(5);
$pdf->Cell(87, 10,'', 0);
...
$pdf->Cell(85, 10, '', 0);
$pdf->Ln(7);
$pdf->Cell(105, 10,'  Razon social:'.$RazonSocial, 0);
$pdf->Cell(85, 10,'  Fecha de emision:'.date("d/m/Y", strtotime($fecha)), 0);
$pdf->Ln(7);
$pdf->Cell(105, 10, '  Domicilio comercial:'.$direccion." ".$ciudad, 0);
$pdf->Cell(85, 10, '  CUIT:'.$Cuit, 0);
$pdf->Ln(10);
