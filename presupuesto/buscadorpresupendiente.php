...
<html lang="en">
  <head>
  <title>Buscar Presupuesto Pendiente</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <script>
		$(function(){
			...
			$('#search').keyup(function(){
				...
				$.ajax({
					type: 'POST',
					url: 'buscadorpredocpendiente.php',
					data: {search},
	 ...
	 <script>
		$(function(){
			...
			$('#search_formnumero').submit(function(e){
				e.preventDefault();
			})
			$('#searchnumero').keyup(function(){
				...
				$.ajax({
					type: 'POST',
					url: 'buscadorprenumeropendiente.php',
					data: {search},
					success: function(resp){
						if(resp!=""){
							$('#resultados').html(resp);
	...
	<header class="sticky-top">
		<div class='container bg-primary rounded'>	
			...
			<!-- Navbar content -->
				...
				<a href="#" class="navbar-brand"><h2>Presupuestos Pendientes</h2></a>
