...
$sql="select max(numero) as numero from presupuesto";
...
<body >
	...
	<!-- Navbar content -->
				...
				<a href="#" class="navbar-brand"><h2>Presupuesto</h2></a>
	...
	<div class="container bg-light p-2">
		...
		<div id="divbuscarCliente">	
				...
				<!-- ********************************************************************************     -->	
					<input type="button" value="Cliente_Nuevo" class="btn btn-secondary" 
			...
			<form id="pedido-data">
	       			<div class="form-row">
						...
						<div class="col">
							<div class="input-group">
							  	<span class="form-control input-sm">estado</span>
							  	<input type="text" class="form-control input-sm" maxlength="8" value="Pendiente" id='estado' readonly>
							</div>
						</div>								
					</div>
...
<!--   arriba nuevo ---------------------  -->
				...
				<!-- ********************************************************************************     -->	
					...
					<button id='agregar' class="btn btn-success btn-sm">Agregar al presupuesto</button>
					   <br>
		         	</table>
